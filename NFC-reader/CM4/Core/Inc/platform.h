...
#define ST25R95_N_IRQ_IN_PIN         nIRQ_IN_Pin           /*!< GPIO pin used for ST25R95 nIRQ_IN            */
#define ST25R95_N_IRQ_IN_PORT        nIRQ_IN_GPIO_Port     /*!< GPIO port used for ST25R95 nIRQ_IN           */


#define PLATFORM_LED_A_PIN           NFC_LED1_Pin              /*!< GPIO pin used for LED A       */
#define PLATFORM_LED_A_PORT          NFC_LED1_GPIO_Port        /*!< GPIO port used for LED A      */
#define PLATFORM_LED_B_PIN           NFC_LED2_Pin              /*!< GPIO pin used for LED B       */
#define PLATFORM_LED_B_PORT          NFC_LED2_GPIO_Port        /*!< GPIO port used for LED B      */
#define PLATFORM_LED_F_PIN           NFC_LED3_Pin              /*!< GPIO pin used for LED F       */
#define PLATFORM_LED_F_PORT          NFC_LED3_GPIO_Port        /*!< GPIO port used for LED F      */
#define PLATFORM_LED_V_PIN           NFC_LED4_Pin              /*!< GPIO pin used for LED V       */
#define PLATFORM_LED_V_PORT          NFC_LED4_GPIO_Port        /*!< GPIO port used for LED V      */
...
#define platformSpiTxRx(txBuf, rxBuf, len)            HAL_SPI_TransmitReceive((&hspi5), (txBuf), (rxBuf), (len), 1000)   /*!< SPI transceive                              */
