...
ReturnCode st25r95Initialize(void)
{
   ...
   // To wake up the device and set it to Ready state, the user must send a
   // low pulse on the IRQ_IN pin. The device then automatically selects the
   // external interface (SPI or UART) and
   // enters Ready state and is able to accept commands after a delay of
   // approximately 3 ms.
   platformDelay(3);
