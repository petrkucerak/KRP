...
/** @defgroup X_NUCLEO_NFC07A1_Exported_Constants
  * @{
  */
...
#define NFC07A1_GPO_IRQHandler            EXTI9_5_IRQHandler

#define NFC07A1_INIT_CLK_GPO_RFD()        __HAL_RCC_GPIOA_CLK_ENABLE( );
