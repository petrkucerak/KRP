...
void HAL_HCD_MspInit(HCD_HandleTypeDef *hcdHandle)
{
   ...
   if (hcdHandle->Instance == USB_OTG_HS) {
      ...
      */
      GPIO_InitStruct.Pin = ULPI_D7_Pin | ULPI_D3_Pin | ULPI_D4_Pin |
                            ULPI_D2_Pin | ULPI_D5_Pin | ULPI_D1_Pin |
                            ULPI_D6_Pin;
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef *hcdHandle)
{
   if (hcdHandle->Instance == USB_OTG_HS) {
      ...
      PB13     ------> USB_OTG_HS_ULPI_D6
      */
      HAL_GPIO_DeInit(GPIOB, ULPI_D7_Pin | ULPI_D3_Pin | ULPI_D4_Pin |
                                 ULPI_D2_Pin | ULPI_D5_Pin | ULPI_D1_Pin |
                                 ULPI_D6_Pin);
                                    ...
                                    uint16_t mps)
{
   ...
   hal_status = HAL_HCD_HC_Init(phost->pData, pipe_num, epnum, dev_address,
                                speed, ep_type, mps);
